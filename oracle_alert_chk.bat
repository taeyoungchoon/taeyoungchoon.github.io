...
find "ORA-" < X:\app\Administrator\diag\rdbms\pantechora\pantecho\trace\alert_pantecho.log > D:\oracle_alert_check\temp.txt

for %%F in ("D:\oracle_alert_check\temp.txt") do if %%~zF equ 0 del "%%F"

if exist D:\oracle_alert_check\temp.txt (type D:\oracle_alert_check\title.txt D:\oracle_alert_check\temp.txt D:\oracle_alert_check\bottom.txt > D:\oracle_alert_check\alert_pantecho_17.log) else (echo file was not found)
